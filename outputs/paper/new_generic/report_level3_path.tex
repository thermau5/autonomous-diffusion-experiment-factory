...
at NFE 9/13 --- genuine headroom on that cell, plausibly because the
exponents $(p,k)$ were validated under the pre-correction NFE accounting
(footnote, Table~\ref{tab:dominance}); re-validating them at true NFE is the
obvious next step and is permitted by our protocol (validation-only tuning).
