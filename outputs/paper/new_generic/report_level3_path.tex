...
per-core $m^\star(d_{\mathrm{EMS}})$ at the borrowed $k\!=\!2$ (not re-tuned
for EMS --- conservative). $^\ddagger$Genuine $d_{\mathrm{EMS}}$ is so
low-$\sigma$-peaked (max/median $198$ vs Heun's $4.1$) that at NFE 64 the
inverse-CDF placement crowds near-identical nodes and the EMS coefficient
solve goes singular; all schedules tie at the floor there regardless.}
\end{table}
